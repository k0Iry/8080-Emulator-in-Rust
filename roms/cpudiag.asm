...
TEMP0   EQU     TEMPP+257       ;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
TEMP1   EQU     TEMPP+258       ;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
TEMP2   EQU     TEMPP+259       ;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
TEMP3   EQU     TEMPP+260       ;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
TEMP4   EQU     TEMPP+261       ;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
SAVSTK	EQU	TEMPP+263	;TEMPORARY STACK-POINTER STORAGE LOCATION
