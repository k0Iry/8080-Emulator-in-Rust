...
TEMP0   EQU     STACK         ;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
TEMP1   EQU     STACK+1       ;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
TEMP2   EQU     STACK+2       ;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
TEMP3   EQU     STACK+3       ;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
TEMP4   EQU     STACK+4       ;TEMPORARY STORAGE FOR CPU TEST MEMORY LOCATIONS
SAVSTK  EQU     STACK+5	      ;TEMPORARY STACK-POINTER STORAGE LOCATION
